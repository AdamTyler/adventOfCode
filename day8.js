...
var lineReader = readline.createInterface({
  input: fs.createReadStream('./inputs/day8.txt')
});
...
lineReader.on('line', function(line) {
  line = line.trim();
  // account for beginning and ending ""
...
lineReader.on('close', function() {
  console.log('Difference is:', memoryChars - stringChars);
  console.log('Part 2 Difference is:', partTwo);
});
